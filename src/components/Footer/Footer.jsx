    ...
    return (
        <div id='Footer' className='container mx-auto text-white text-center pt-12'>
            <div>
                ...
                <p className='text-2xl md:text-4xl px-4 md:px-1 pt-5 font-medium bg-gradient-to-r from-fuchsia-600 to-cyan-400  bg-clip-text text-transparent'>Feel free to contact me if you have any suggestions or questions.</p>
            </div>
         ...
         <a
          ...
          >
           <img src="/icon/email.png" alt="" className='w-[50px] h-[50px]'/>
            ...
            <p className='text-lg md:text-2xl'>Designet & Developed by Abdullayev Ulugbek</p>
