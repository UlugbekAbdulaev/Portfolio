        ...
        <div className="bg-[#0F1624] sticky top-0 z-10">
            <div className="container mx-auto flex justify-between items-center text-xl  text-white py-10">
                ...
                <div className="flex gap-15">
                    <p className="hover:cursor-pointer hover:text-amber-500 transition-transform duration-300 hover:scale-110"><Link duration={500} offset={-70} href={"/"} hrefLang="About">About me</Link></p>
                    ...
                    <Link  duration={500} offset={-70} href="#Footer"><p className="hover:cursor-pointer hover:text-amber-500 transition-transform duration-300 hover:scale-110">Contact me</p></Link>
                </div>
            </div>
        </div>
    )
